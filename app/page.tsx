export default function Home() {
  return (
    ...
    >
      <div
        className="bg-white w-full shadow-lg p-5 rounded-3xl max-w-screen-sm
      dark:bg-gray-500 "
      >
        ...
        <div className="my-2 flex items-center gap-2">
          <span
            className="bg-green-400 rounded-full px-3 py-1.5 text-xs 
          font-medium text-white uppercase transition
